...
<div id="wrapper">
   ...
   <div id="content_left">
	*注意:はじめにお読みください*</br>
	これからいくつかの質問に答えることで、あなたにとって最安の料金プランを提示させていただきます。ただしこの金額にはいくつかの前提があります。</br>
	</br>
	・2年契約と個人での利用を前提に算出されています。家族での算出は作成中です。</br>
	・結果では基本的に2年間での月額を表示しますが、softbank新料金プランの場合は一年目のみのサービスがあるため、一年目のみとなります。
	</div>
